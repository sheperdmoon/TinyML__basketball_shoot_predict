...
constexpr int kLylGesture = 0;
constexpr int kXzyGesture = 1;
constexpr int kXmhGesture = 2;
constexpr int kLjrGesture = 3;
constexpr int kMxdGesture = 4;
constexpr int kNoGesture = 5;
