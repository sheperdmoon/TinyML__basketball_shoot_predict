...
def train_net(
  ...
  epochs = 50  # TODO[14] 配置参数：优化器、损失值、度量指标、epoch、batch_size
  batch_size = 64
  ...
  model.fit(train_data,
            ...
            steps_per_epoch=1000,  # 可以修改，即一次epoch训练多少个batch
  ...
  confusion = tf.math.confusion_matrix(labels=tf.constant(test_labels),
                                       ...
                                       num_classes=2)  # TODO[12]评估矩阵，要改这个num_classes
...
if __name__ == "__main__":
  ...
  seq_length = 200  # TODO[7] 修改input长度
